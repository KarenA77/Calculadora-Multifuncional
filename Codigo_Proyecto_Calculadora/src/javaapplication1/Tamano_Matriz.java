...
public class Tamano_Matriz extends javax.swing.JFrame {
private int max; 


    public Tamano_Matriz() {
        initComponents();
    ...
    this.max=Integer.parseInt(this.tamano.getText());
        ...
        switch(this.max){
            ...
            case 2: 
                deter2 def =new deter2();
                def.setVisible(true);
                this.dispose();
                break;          

            case 3:
                deter3 deg = new deter3();
                deg.setVisible(true);
                this.dispose();
                break;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(39, 39, 39)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(crear, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tamano_Matriz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tamano_Matriz().setVisible(true);
            }
        });
    }
